...
wget https://github.com/davidhong1/change-aws-lightsail-ip/releases/download/alpha-v0.2/change-aws-lightsail-ip -O /etc/change-aws-lightsail-ip/change-aws-lightsail-ip && chmod +x /etc/change-aws-lightsail-ip/change-aws-lightsail-ip
